...
| Canonical completed outcomes | Implemented v1.1 (publish + settle/repair + enrichment) — [#70](https://github.com/GlitchTrader/glitch-topstep/issues/70) | Live PRAC proof of `learning_eligible` with MAE/MFE; optional backfill (Phase D); commission if ProjectX exposes it |
