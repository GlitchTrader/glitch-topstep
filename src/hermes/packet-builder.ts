...
export interface DirectDecisionPacket {
  ...
  data_quality: {
    ...
    /** Whether ProjectX mutations may proceed. */
  ...
  return {
    ...
    required_output_template: {
      ...
      decision_audit: {
        ...
        aggressive_case: "Replace with the compact aggressive alternative.",
        conservative_case: "Replace with the compact conservative alternative.",
        decisive_evidence: "Replace",
        disconfirming_evidence: "Replace with compact contrary evidence.",
        change_condition: "Replace with one compact reassessment trigger.",
